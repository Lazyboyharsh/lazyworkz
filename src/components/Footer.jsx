...
const Footer = () => {
  // 1. State for visitor count
  const [visitorCount, setVisitorCount] = useState(15);

  // 2. Simulation Logic (Fluctuates count to look live)
  useEffect(() => {
    const interval = setInterval(() => {
      setVisitorCount(prev => {
        const change = Math.floor(Math.random() * 3) - 1; // -1, 0, or 1
        const result = prev + change;
        return result < 10 ? 10 : result > 30 ? 30 : result;
      });
    }, 3000);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              {/* WhatsApp */}
              <a href="https://whatsapp.com/channel/0029Vb7H9DQFi8xj4l65K80W" aria-label="WhatsApp" className="hover:text-green-500 transition-colors">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/lazyworkz__/" aria-label="Instagram" className="hover:text-pink-500 transition-colors">
          ...
          {/* Column 4: Newsletter (Commented out) */}
          {/* <div>...</div> */}
